...
| `ScoreTracker.Tests.Api` | + `xunit`, `Moq` | One of the two sanctioned `ScoreTracker.Web`-referencing test projects — it pins the public API wire shapes, which live in Web's controllers/DTOs. Same doubling rules as `ScoreTracker.Tests`. |
