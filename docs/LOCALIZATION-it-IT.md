...
|---|---|
| rules | regole |
| window (the 1:45) | finestra |
| buzzer | sirena |
| clock | cronometro |
| grade multiplier | moltiplicatore di grado |
| level value | valore del livello |
| stamina bonus | bonus resistenza |
| broken score | punteggio rotto |
...
| timed by you | cronometrata da te |
...
| English | it-IT |
|---|---|
| draft (an unpublished session) | bozza |
| record book | libro dei record |
| set | set (unchanged) |
| rest chart | chart di riposo |
| finisher | chiusura |
| window (the 1:45) | finestra |
| push (how hard) | spingere |
| publish | pubblicare |
| import | importare |
| closing chart | chart di chiusura |
