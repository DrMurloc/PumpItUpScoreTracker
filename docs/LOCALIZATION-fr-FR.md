...
|---|---|
| rules | règles |
| window (the 1:45) | fenêtre |
| buzzer | buzzer |
| clock | chrono |
| grade multiplier | multiplicateur de grade |
| level value | valeur du niveau |
| stamina bonus | bonus d'endurance |
| broken score | score cassé |
...
| timed by you | chronométrée par vous |
...
| English | fr-FR |
|---|---|
| draft (an unpublished session) | brouillon |
| record book | carnet de records |
| set | set (unchanged) |
| rest chart | chart de repos |
| finisher | finisseuse |
| window (the 1:45) | fenêtre |
| push (how hard) | pousser |
| publish | publier |
| import | importer |
| closing chart | chart de clôture |
