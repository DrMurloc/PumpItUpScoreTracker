...
| board | tablero |
| downtime | descanso |
| balanced level | nivel equilibrado |
| Draft | Borrador |
| Planner | Planificador |
| Past seasons | Temporadas anteriores |
| Doubles / Singles | Dobles / Simples (as the mix keys already do) |
| score | puntaje (never puntuación — the es-ES word) |
...
| English | es-MX |
|---|---|
| draft (an unpublished session) | borrador |
| record book | libro de récords |
| set | set (unchanged) |
| rest chart | chart de descanso |
| finisher | cierre |
| window (the 1:45) | ventana |
| push (how hard) | apretar |
| publish | publicar |
| import | importar |
| closing chart | chart de cierre |
