...
3. **Populate** — pulls the full chart/song catalog, all seven tier lists, scoring levels, and *your own scores* from the live site into your local database. Takes a minute or two.
