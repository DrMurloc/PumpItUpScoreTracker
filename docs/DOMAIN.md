...
- **Broken** — a stage-broken (failed) attempt. It becomes your record only on a chart you have never passed, and only when you opt in on the import. A **walk-off** — a break with nothing judged — is never stored at all.
