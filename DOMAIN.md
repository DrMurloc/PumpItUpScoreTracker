...
- **Weekly Charts** — a weekly-rotating set of charts the community competes on, scraped from the official PIU site. Refreshed by the recurring `RotateWeeklyCharts`. Drives Competitive Level progress.
