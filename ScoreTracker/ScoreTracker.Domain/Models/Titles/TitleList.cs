...
public static class TitleList
{
    private static readonly Title[] Titles =
    {
        ...
        new DifficultyLevelTitle("Expert LV.1", 24, 30),
        new DifficultyLevelTitle("Expert LV.2", 25, 15),
        new DifficultyLevelTitle("Expert LV.3", 26, 7),
        new DifficultyLevelTitle("Expert LV.4", 27, 3),
        new DifficultyLevelTitle("The Master", 28, 1),
