...
public static class PhoenixTitleList
{
    private static readonly PhoenixTitle[] Titles =
    {
        ...
        new PhoenixSkillTitle("BRACKET", 10, "Phalanx", ChartType.Double, 24),
        ...
        new PhoenixSkillTitle("BRACKET", 6, "Meteo5cience", ChartType.Double, 22),
        new PhoenixSkillTitle("BRACKET", 5, "Phalanx", ChartType.Single, 22),
        new PhoenixSkillTitle("BRACKET", 4, "What Happened", ChartType.Single, 21),
        new PhoenixSkillTitle("BRACKET", 3, "Meteo5cience", ChartType.Single, 21),
        ...
        new PhoenixSkillTitle("HALF", 6, "Utsushiyo No Kaze", ChartType.Double, 20),
        ...
        new PhoenixSkillTitle("GIMMICK", 8, "Twist of Fate", ChartType.Single, 19),
        ...
        new PhoenixSkillTitle("GIMMICK", 5, "Rock the house - SHORT CUT - S18", ChartType.Single, 18),
        new PhoenixSkillTitle("GIMMICK", 4, "Come to Me S17", ChartType.Single, 17),
        new PhoenixSkillTitle("GIMMICK", 3, "Ugly Dee S17", ChartType.Single, 17),
