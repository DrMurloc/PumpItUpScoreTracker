...
public static class PhoenixTitleList
{
    private static readonly PhoenixTitle[] Titles =
    {
        ...
        new PhoenixDifficultyTitle("Intermediate Lv. 1", 10, 2000, "INTERMEDIATE"),
        new PhoenixDifficultyTitle("Intermediate Lv. 2", 11, 2200, "INTERMEDIATE"),
        new PhoenixDifficultyTitle("Intermediate Lv. 3", 12, 2600, "INTERMEDIATE"),
        new PhoenixDifficultyTitle("Intermediate Lv. 4", 13, 3200, "INTERMEDIATE"),
        new PhoenixDifficultyTitle("Intermediate Lv. 5", 14, 4000, "INTERMEDIATE"),
        new PhoenixDifficultyTitle("Intermediate Lv. 6", 15, 5000, "INTERMEDIATE"),
        new PhoenixDifficultyTitle("Intermediate Lv. 7", 16, 6200, "INTERMEDIATE"),
        new PhoenixDifficultyTitle("Intermediate Lv. 8", 17, 7600, "INTERMEDIATE"),
        new PhoenixDifficultyTitle("Intermediate Lv. 9", 18, 9200, "INTERMEDIATE"),
        new PhoenixDifficultyTitle("Intermediate Lv. 10", 19, 11000, "INTERMEDIATE"),
        new PhoenixDifficultyTitle("Advanced Lv. 1", 20, 13000, "ADVANCED"),
        new PhoenixDifficultyTitle("Advanced Lv. 2", 20, 26000, "ADVANCED"),
        new PhoenixDifficultyTitle("Advanced Lv. 3", 20, 39000, "ADVANCED"),
        new PhoenixDifficultyTitle("Advanced Lv. 4", 21, 15000, "ADVANCED"),
        new PhoenixDifficultyTitle("Advanced Lv. 5", 21, 30000, "ADVANCED"),
        new PhoenixDifficultyTitle("Advanced Lv. 6", 21, 45000, "ADVANCED"),
        new PhoenixDifficultyTitle("Advanced Lv. 7", 22, 17500, "ADVANCED"),
        new PhoenixDifficultyTitle("Advanced Lv. 8", 22, 35000, "ADVANCED"),
        new PhoenixDifficultyTitle("Advanced Lv. 9", 22, 52500, "ADVANCED"),
        new PhoenixDifficultyTitle("Advanced Lv. 10", 22, 70000, "ADVANCED"),
        new PhoenixDifficultyTitle("Expert Lv. 1", 23, 40000, "EXPERT"),
        new PhoenixDifficultyTitle("Expert Lv. 2", 23, 80000, "EXPERT"),
        new PhoenixDifficultyTitle("Expert Lv. 3", 24, 30000, "EXPERT"),
        new PhoenixDifficultyTitle("Expert Lv. 4", 24, 60000, "EXPERT"),
        new PhoenixDifficultyTitle("Expert Lv. 5", 25, 20000, "EXPERT"),
        new PhoenixDifficultyTitle("Expert Lv. 6", 25, 40000, "EXPERT"),
        new PhoenixDifficultyTitle("Expert Lv. 7", 26, 13000, "EXPERT"),
        new PhoenixDifficultyTitle("Expert Lv. 8", 26, 26000, "EXPERT"),
        new PhoenixDifficultyTitle("Expert Lv. 9", 27, 3500, "EXPERT"),
        new PhoenixDifficultyTitle("Expert Lv. 10", 27, 7000, "EXPERT"),
        new PhoenixDifficultyTitle("The Master", 28, 1900, "THE MASTER"),
        ...
        new PhoenixBasicTitle("B1G ONE 2024 SUPPORTER", "A title given to B1G ONE 2024 Supporters"),
        new PhoenixBasicTitle("B1G ONE 2024 PLAYER", "A title given to B1G ONE 2024 Players"),
        new PhoenixBasicTitle("RISE CHALLENGER", "A title given to 2025 PlayX4 Dominion RISE League Players"),
        new PhoenixBasicTitle("PHOENIX CHALLENGER", "A title given to 2025 PlayX4 Dominion PHOENIX League Players"),
        new PhoenixBasicTitle("DOMINION CHALLENGER", "A title given to 2025 PlayX4 Dominion Participants"),
        ...
        new PhoenixBasicTitle("LOVERS (Gold)", "1000+ CoOp plays", "CoOp", "LOVERS", 2),
        new PhoenixBasicTitle("LOVERS (Silver)", "100+ CoOp plays", "CoOp", "LOVERS", 1),
        ...
        new PhoenixBasicTitle("VVIP MEMBER", "10000 or more plays", "Play Count", "MEMBERSHIP", 5),
        new PhoenixBasicTitle("VIP MEMBER", "5000 or more plays", "Play Count", "MEMBERSHIP", 4),
        new PhoenixBasicTitle("DIAMOND MEMBER", "1000 or more plays", "Play Count", "MEMBERSHIP", 3),
        new PhoenixBasicTitle("Platinum Member", "500 or more plays", "Play Count", "MEMBERSHIP", 2),
        new PhoenixBasicTitle("GOLD MEMBER", "100 or more plays", "Play Count", "MEMBERSHIP", 1),
        ...
        new PhoenixBasicTitle("PERFECT GAMER (Bronze)", "100+ PGs", "Plates", "PERFECT GAMER", 1),
        new PhoenixBasicTitle("ULTIMATE GAMER (Platinum)", "3000+ UGs", "Plates", "ULTIMATE GAMER", 4),
        new PhoenixBasicTitle("ULTIMATE GAMER (Gold)", "1000+ UGs", "Plates", "ULTIMATE GAMER", 3),
        new PhoenixBasicTitle("ULTIMATE GAMER (Silver)", "500+ UGs", "Plates", "ULTIMATE GAMER", 2),
        new PhoenixBasicTitle("ULTIMATE GAMER (Bronze)", "100+ UGs", "Plates", "ULTIMATE GAMER", 1),
        new PhoenixBasicTitle("EXTREME GAMER (Platinum)", "3000+ EGs", "Plates", "EXTREME GAMER", 4),
        new PhoenixBasicTitle("EXTREME GAMER (Gold)", "1000+ EGs", "Plates", "EXTREME GAMER", 3),
        new PhoenixBasicTitle("EXTREME GAMER (Silver)", "500+ EGs", "Plates", "EXTREME GAMER", 2),
        new PhoenixBasicTitle("EXTREME GAMER (Bronze)", "100+ EGs", "Plates", "EXTREME GAMER", 1),
        new PhoenixBasicTitle("SUPERB GAMER (Platinum)", "3000+ SGs", "Plates", "SUPERB GAMER", 4),
        new PhoenixBasicTitle("SUPERB GAMER (Gold)", "1000+ SGs", "Plates", "SUPERB GAMER", 3),
        new PhoenixBasicTitle("SUPERB GAMER (Silver)", "500+ SGs", "Plates", "SUPERB GAMER", 2),
        new PhoenixBasicTitle("SUPERB GAMER (Bronze)", "100+ SGs", "Plates", "SUPERB GAMER", 1),
        new PhoenixBasicTitle("MARVELOUS GAMER (Platinum)", "3000+ MGs", "Plates", "MARVELOUS GAMER", 4),
        new PhoenixBasicTitle("MARVELOUS GAMER (Gold)", "1000+ MGs", "Plates", "MARVELOUS GAMER", 3),
        new PhoenixBasicTitle("MARVELOUS GAMER (Silver)", "500+ MGs", "Plates", "MARVELOUS GAMER", 2),
        new PhoenixBasicTitle("MARVELOUS GAMER (Bronze)", "100+ MGs", "Plates", "MARVELOUS GAMER", 1),
        new PhoenixBasicTitle("TALENTED GAMER (Platinum)", "3000+ TGs", "Plates", "TALENTED GAMER", 4),
        new PhoenixBasicTitle("TALENTED GAMER (Gold)", "1000+ TGs", "Plates", "TALENTED GAMER", 3),
        new PhoenixBasicTitle("TALENTED GAMER (Silver)", "500+ TGs", "Plates", "TALENTED GAMER", 2),
        new PhoenixBasicTitle("TALENTED GAMER (Bronze)", "100+ TGs", "Plates", "TALENTED GAMER", 1),
        new PhoenixBasicTitle("FAIR GAMER (Platinum)", "3000+ FGs", "Plates", "FAIR GAMER", 4),
        new PhoenixBasicTitle("FAIR GAMER (Gold)", "1000+ FGs", "Plates", "FAIR GAMER", 3),
        new PhoenixBasicTitle("FAIR GAMER (Silver)", "500+ FGs", "Plates", "FAIR GAMER", 2),
        new PhoenixBasicTitle("FAIR GAMER (Bronze)", "100+ FGs", "Plates", "FAIR GAMER", 1),
        new PhoenixBasicTitle("ROUGH GAMER (Platinum)", "3000+ RGs", "Plates", "ROUGH GAMER", 4),
        new PhoenixBasicTitle("ROUGH GAMER (Gold)", "1000+ RGs", "Plates", "ROUGH GAMER", 3),
        new PhoenixBasicTitle("ROUGH GAMER (Silver)", "500+ RGs", "Plates", "ROUGH GAMER", 2),
        new PhoenixBasicTitle("ROUGH GAMER (Bronze)", "100+ RGs", "Plates", "ROUGH GAMER", 1),
        new PhoenixBasicTitle("SPECIALIST", "Earn all skill titles", "Skill"),
        new PhoenixBasicTitle("[BRACKET] EXPERT", "Earn Bracket Titles 1-10", "Skill", "BRACKET", 11),
        ...
        new PhoenixBasicTitle("[HALF] EXPERT", "Earn Half Titles 1-10", "Skill", "HALF", 11),
        ...
        new PhoenixBasicTitle("[GIMMICK] EXPERT", "Earn Gimmick Titles 1-10", "Skill", "GIMMICK", 11),
        ...
        new PhoenixBasicTitle("[DRILL] EXPERT", "Earn Drill Titles 1-10", "Skill", "DRILL", 11),
        ...
        new PhoenixBasicTitle("[RUN] EXPERT", "Earn Run Titles 1-10", "Skill", "RUN", 11),
        ...
        new PhoenixBasicTitle("[TWIST] EXPERT", "Earn Twist Titles 1-10", "Skill", "TWIST", 11),
        ...
        new PhoenixBasicTitle("A huge fan of SPHAM", "500+ plays on SPHAM charts", "Step Artist", "SPHAM", 2),
        new PhoenixBasicTitle("SPHAM FOLLOWER", "100+ plays on SPHAM charts", "Step Artist", "SPHAM", 1),
        new PhoenixBasicTitle("A huge fan of CONRAD", "500+ plays on CONRAD charts", "Step Artist", "CONRAD", 2),
        new PhoenixBasicTitle("CONRAD FOLLOWER", "100+ playso n CONRAD charts", "Step Artist", "CONRAD", 1),
        new PhoenixBasicTitle("A huge fan of DULKI", "500+ plays on Dulki charts", "Step Artist", "DULKI", 2),
        new PhoenixBasicTitle("DULKI FOLLOWER", "100+ plays on Dulki charts", "Step Artist", "DULKI", 1),
        new PhoenixBasicTitle("A huge fan of SUNNY", "500+ plays on Sunny charts", "Step Artist", "SUNNY", 2),
        new PhoenixBasicTitle("SUNNY FOLLOWER", "100+ plays on Sunny charts", "Step Artist", "SUNNY", 1),
        new PhoenixBasicTitle("A huge fan of FEFEMZ", "500+ plays on FEFEMZ charts", "Step Artist", "FEFEMZ", 2),
        new PhoenixBasicTitle("FEFEMZ FOLLOWER", "100+ plays on FEFEMZ charts", "Step Artist", "FEFEMZ", 1),
        new PhoenixBasicTitle("A huge fan of EXC", "500+ plays on EXC charts", "Step Artist", "EXC", 2),
        new PhoenixBasicTitle("EXC FOLLOWER", "100+ plays on EXC charts", "Step Artist", "EXC", 1)
    };
    ...
    static PhoenixTitleList()
    {
        ...
        // Display rails. Note this is NOT the grouping above: the difficulty titles score as
        // nine ladders (one per level) and draw as four rails (Intermediate through The
        // Master). Skill, boss-breaker and basic titles take their rail at construction.
        TitleHelpers.Rail(Titles.OfType<PhoenixDifficultyTitle>(), t => t.Tier);
        TitleHelpers.Rail(Titles.OfType<PhoenixCoOpTitle>(), _ => (Name?)"CO-OP");
        TitleHelpers.Rail(Titles.OfType<PhoenixBossBreakerTitle>(), t => t.Mix,
