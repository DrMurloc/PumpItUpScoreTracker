...
namespace ScoreTracker.ChartIntelligence.Infrastructure.Entities
{
    ...
    // the TierListSaga's PUMBILITY rebuild, one row set per folder per cohort.
    //
    ...
    // difficulty title level, a Phoenix 2 PUMBILITY title rung, or PumbilityCohortKeys.Community
