...
internal static class PivotPrompt
{
    public static string System()
    {
        return $"""
                ...
                Always leave a space on both sides of a marker, even where the language would
                attach a particle or an article directly to it. Never drop one, invent one,
                repeat one, or alter one — and never write a URL of your own. Do not list markers
                as entities; they are handled outside your output.
