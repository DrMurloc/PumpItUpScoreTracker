...
public sealed class LayerDependencyTests
{
    ...
    private static readonly Assembly ApplicationAssembly = typeof(Application.Commands.SaveChartToListCommand).Assembly;
    ...
    public void OnlyIdentityInjectsTheUserRepository()
    {
        ...
        var verticalAssemblies = new[]
        {
            ...
            typeof(Rivals.Wiring.RivalsRegistrationExtensions).Assembly
        };
