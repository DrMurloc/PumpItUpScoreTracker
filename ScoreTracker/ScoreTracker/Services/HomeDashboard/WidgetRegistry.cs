...
{
    // The starter trio lands here in C5–C7; catalog widgets one PR at a time (D18).
    private static readonly WidgetDescriptor[] Descriptors = Array.Empty<WidgetDescriptor>();
