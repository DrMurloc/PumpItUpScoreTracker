...
///     (docs/design/rise.md D25). A sitting already closed, or none at all, leaves nothing to do, so a
///     repeat never announces anything twice — but it closes whatever is open when it runs, including a
///     sitting the next session has started. The next play on the mix starts a new sitting.
/// </summary>
