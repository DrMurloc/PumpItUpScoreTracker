...
/// <summary>
///     Deletes title progression and suggestion feedback for a purged account (stats, history,
///     and highest title ride the ledger's wipe flow). Idempotent — the purge event re-fires
///     daily for a week.
/// </summary>
