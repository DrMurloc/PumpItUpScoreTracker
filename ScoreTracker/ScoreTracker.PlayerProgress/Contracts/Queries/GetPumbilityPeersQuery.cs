...
{
    /// <summary>
    ///     The current user's PUMBILITY peers of one chart type — accounts and board players alike
///     (docs/design/pumbility-overhaul.md D59), for a surface that
    ...
    public sealed record GetPumbilityPeersQuery(ChartType ChartType, MixEnum Mix = MixEnum.Phoenix)
        : IQuery<IReadOnlyCollection<PeerVoice>>;
}
