...
public sealed class EFPreferenceRatingRepository : IChartPreferenceRepository
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        if (entity == null)
            await database.UserPreferenceRating.AddAsync(new UserPreferenceRatingEntity
            {
                Id = Guid.NewGuid(),
                MixId = mixId,
                UserId = userId,
        ...
        CancellationToken cancellationToken)
    {
        ...
        if (entity == null)
        {
            await database.ChartPreferenceRating.AddAsync(new ChartPreferenceRatingEntity
            {
                Id = Guid.NewGuid(),
                MixId = mixId,
                ChartId = chartId,
