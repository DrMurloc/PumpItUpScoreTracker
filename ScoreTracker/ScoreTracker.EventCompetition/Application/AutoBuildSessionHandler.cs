...
{
    internal sealed class AutoBuildSessionHandler : IRequestHandler<AutoBuildSessionQuery, TournamentSession>
    {
        ...
        public async Task<TournamentSession> Handle(AutoBuildSessionQuery request, CancellationToken cancellationToken)
        {
            ...
            var orderedScores = (await _phoenixRecords.GetBestScores(MixEnum.Phoenix, request.UserId,
                    cancellationToken))
